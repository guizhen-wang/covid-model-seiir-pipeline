...
class CompareCsvTaskSpecification(workflow.TaskSpecification):
    """Specification of execution parameters for compare csv tasks."""
    default_max_runtime_seconds = 5000
...
class DiagnosticsWorkflowSpecification(workflow.WorkflowSpecification):
    ...
    tasks = {
        ...
        DIAGNOSTICS_JOBS.compare_csv: CompareCsvTaskSpecification,
    }
...
class DiagnosticsSpecification(utilities.Specification):
    ...
    def __init__(self,
                 ...
                 compare_csv: CompareCsvSpecification):
        self._data = data
        self._workflow = workflow
        self._grid_plots = grid_plots
        self._compare_csv = compare_csv
    ...
    def parse_spec_dict(cls, specification: Dict) -> Tuple:
        ...
        compare_csv = CompareCsvSpecification(**specification.get('compare_csv', {}))
        return data, workflow, grid_plots, compare_csv
    ...
    @property
    def compare_csv(self) -> CompareCsvSpecification:
        return self._compare_csv
    ...
    def to_dict(self):
        ...
        return {
            ...
            'compare_csv': self.compare_csv.to_dict(),
        }
